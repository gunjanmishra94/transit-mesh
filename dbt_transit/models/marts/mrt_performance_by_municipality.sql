...
SELECT
    ...
    MEDIAN(m.arrival_delay_sec) / 60.0 AS median_delay_minutes,
    STDDEV(m.arrival_delay_sec) / 60.0 AS delay_stddev_minutes,
    QUANTILE_CONT(m.arrival_delay_sec, 0.9) / 60.0 AS p90_delay_minutes,
